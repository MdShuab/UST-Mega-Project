...
<center>
<h1 style="font-size: 50px; font-family: cursive; color: red"><i><u>${msg }</u></i></b></h1>
<center><h1 style="font-size: 50px; font-family: cursive;"><i><u>Searched Products</u></i></b></h1></center>
...
<td><center><input type="submit" value="Add Cart"><%-- <a href='UpdateProduct?pid=${pdto.getProduct_id() }'>Update</a> --%></center></td>
</tr></form>
</c:forEach>
</table>
